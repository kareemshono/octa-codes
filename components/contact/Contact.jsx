        ...
        <div className={styles.colRight}> 
            ...
            <form className={styles.form}>
                <div className={styles.formGroup}>
                    ...
                    <input required className={styles.formControl} type="text" id="name" name="name" />
                </div>
                <div className={styles.formGroup}>
                    <label className={styles.formLabel} htmlFor="email">Email*</label>
                    <input required className={styles.formControl} type="email" id="email" name="email" />
                </div>
                <div className={styles.formGroup}>
                    <label className={styles.formLabel} htmlFor="phone">Phone Number*</label>
                    <input required className={styles.formControl} type="text" id="phone" name="phone" />
                </div>
                <div className={styles.formGroup}>
                    <label className={styles.formLabel} htmlFor="message">Message*</label>
                    <textarea required className={styles.formControl} rows={4} type="text" id="message" name="message" />
                </div>
